                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="icon" class="form-control" value="{{ old('icon') }}" placeholder="fa-folder">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" name="is_active" class="form-check-input" value="1" {{ old('is_active', true) ? 'checked' : '' }} id="is_active">
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" name="show_in_menu" class="form-check-input" value="1" {{ old('show_in_menu', true) ? 'checked' : '' }} id="show_in_menu">
