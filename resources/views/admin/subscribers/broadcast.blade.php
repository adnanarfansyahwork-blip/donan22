...
@section('title', 'Broadcast Newsletter')
@section('page-title', 'Broadcast to Subscribers')
...
<div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <p class="text-sm text-blue-700 mt-1">
                    This email will be sent to <strong>{{ $activeCount }} active subscriber(s)</strong>. 
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <form action="{{ route('admin.subscribers.broadcast.send') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="flex items-center justify-between border-t border-gray-200 pt-6">
                ...
                <div class="flex gap-3">
                    ...
                    <button type="submit" 
                            onclick="return confirm('Are you sure you want to send this email to {{ $activeCount }} subscribers?')"
...
@push('scripts')
<script>
var appName = '@php echo config("app.name"); @endphp';
var siteUrl = '@php echo config("app.url"); @endphp';
