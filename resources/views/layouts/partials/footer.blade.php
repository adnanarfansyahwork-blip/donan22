        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                <a href="{{ route('home') }}" class="inline-block">
                    <img src="{{ asset('assets/images/logo.png') }}" alt="Donan22" class="h-10 w-auto">
                </a>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('software.index') }}" class="text-gray-400 hover:text-white transition-colors">Software</a></li>
                    <li><a href="{{ route('mobile-apps.index') }}" class="text-gray-400 hover:text-white transition-colors">Mobile Apps</a></li>
                    <li><a href="{{ route('tutorials.index') }}" class="text-gray-400 hover:text-white transition-colors">Tutorials</a></li>
