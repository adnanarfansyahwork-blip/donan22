...
<?php $__env->startSection('canonical', $post->canonical_url ?? route('posts.show', $post->slug)); ?>
<?php $__env->startSection('robots', $post->is_indexable ? 'index, follow' : 'noindex, nofollow'); ?>
...
<?php echo json_encode($post->getSchemaMarkup(), JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT); ?>

</script>
<!-- Breadcrumb Schema Markup (SEO) -->
<script type="application/ld+json">
<?php echo json_encode($post->getBreadcrumbSchema(), JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div class="lg:col-span-2">
                ...
                <?php if(isset($previousPost) || isset($nextPost)): ?>
                <div class="bg-white rounded-xl border border-gray-200 p-4 mb-6 shadow-sm">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <!-- Previous Post -->
                        <div class="flex-1">
                            <?php if(isset($previousPost) && $previousPost): ?>
                                <a href="<?php echo e($previousPost->url); ?>" class="group block h-full p-3 rounded-lg border border-gray-100 hover:border-primary-200 hover:bg-primary-50/30 transition-all">
                        ...
                        <div class="flex-1">
                            <?php if(isset($nextPost) && $nextPost): ?>
                                <a href="<?php echo e($nextPost->url); ?>" class="group block h-full p-3 rounded-lg border border-gray-100 hover:border-primary-200 hover:bg-primary-50/30 transition-all text-right">
                ...
                <?php if(isset($moreRelatedPosts) && $moreRelatedPosts->count()): ?>
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden mb-6 shadow-sm">
                    ...
                    <div class="p-4">
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                            <?php $__currentLoopData = $moreRelatedPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e($related->url); ?>" class="group block">
                                    ...
                                    <?php if($related->category): ?>
                                        <span class="text-[10px] text-gray-400 mt-0.5 block"><?php echo e($related->category->name); ?></span>
                                    <?php endif; ?>
                                </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
