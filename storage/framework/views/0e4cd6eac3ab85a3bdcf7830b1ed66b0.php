                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <?php else: ?>
                                <div class="w-10 h-10 bg-<?php echo e(['blue', 'green', 'purple', 'orange'][$loop->index % 4]); ?>-100 rounded-lg flex items-center justify-center">
                                    <i class="bi bi-folder text-<?php echo e(['blue', 'green', 'purple', 'orange'][$loop->index % 4]); ?>-600"></i>
                                </div>
                            <?php endif; ?>
                            <span class="font-medium text-gray-900"><?php echo e($category->name); ?></span>
                        </div>
                    </td>
                    <td class="px-6 py-4 text-sm text-gray-500"><?php echo e($category->slug); ?></td>
                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($category->posts_count); ?></td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="flex items-center justify-end space-x-2">
                            <button type="button" class="edit-category-btn p-2 text-gray-400 hover:text-primary-600" title="Edit"
                                    ...
                                    data-is-active="<?php echo e($category->is_active ? '1' : '0'); ?>">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\donan22-laravel-new\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>