...
<?php $__env->startSection('canonical', route('mobile-apps.index')); ?>
<?php $__env->startSection('robots', request()->has('page') || request()->has('platform') ? 'noindex, follow' : 'index, follow'); ?>
