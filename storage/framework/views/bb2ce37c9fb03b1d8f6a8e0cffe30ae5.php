...
<body class="bg-gray-100 min-h-screen flex items-center justify-center px-4">
    <div class="text-center">
        ...
        <a href="<?php echo e(url('/')); ?>" class="inline-block mt-6 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium">
            Go Home
        </a>
    </div>
</body>
</html>
<?php /**PATH /home/u828471719/domains/donan22.com/public_html/resources/views/errors/404.blade.php ENDPATH**/ ?>