...
<article class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
    <a href="<?php echo e($post->url); ?>" class="flex">
        ...
        <div class="flex-1 p-3 flex flex-col justify-center min-w-0">
            ...
            <div class="flex items-center gap-2 mb-1 text-xs">
                <?php if($post->category): ?>
                    <span class="font-bold uppercase text-emerald-600"><?php echo e($post->category->name); ?></span>
                    <span class="text-gray-300">|</span>
                <?php endif; ?>
                <span class="text-gray-400 uppercase"><?php echo e($post->published_at?->format('M d, Y') ?? 'Draft'); ?></span>
            </div>
