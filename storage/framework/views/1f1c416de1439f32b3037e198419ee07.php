    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <aside class="lg:col-span-1">
            <div class="sticky top-24 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-4">
                        <ul class="space-y-1">
                            <li>
                                <a href="<?php echo e(route('tutorials.index')); ?>" 
                                   class="flex items-center justify-between px-3 py-2.5 rounded-lg transition-colors <?php echo e(!request('category') ? 'bg-purple-50 text-purple-700' : 'text-gray-600 hover:bg-gray-50'); ?>">
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a href="<?php echo e(route('tutorials.index', ['category' => $category->slug])); ?>" 
                                       class="flex items-center justify-between px-3 py-2.5 rounded-lg transition-colors <?php echo e(request('category') == $category->slug ? 'bg-purple-50 text-purple-700' : 'text-gray-600 hover:bg-gray-50'); ?>">
                                        <span class="flex items-center gap-2">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="bg-gradient-to-r from-indigo-500 to-blue-500 px-5 py-4">
                        <h3 class="text-white font-bold text-center text-lg">
                    ...
                    <div class="p-4 space-y-2">
                        <a href="<?php echo e(route('software.index')); ?>" 
                           class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                            <span class="w-8 h-8 flex items-center justify-center bg-blue-100 text-blue-600 rounded-lg">
                        ...
                        <a href="<?php echo e(route('categories.index')); ?>" 
                           class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                            <span class="w-8 h-8 flex items-center justify-center bg-orange-100 text-orange-600 rounded-lg">
