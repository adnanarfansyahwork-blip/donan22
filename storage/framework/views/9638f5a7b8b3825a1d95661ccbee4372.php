                ...
                <div class="mt-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 max-h-60 overflow-y-auto">
                        <ul class="space-y-2 text-sm">
                            <?php $__currentLoopData = array_slice($urls, 0, 10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if(count($urls) > 10): ?>
                            <p class="text-gray-500 text-sm mt-3">... and <?php echo e(count($urls) - 10); ?> more URLs</p>
                        <?php endif; ?>
                    </div>
                </div>
            <?php else: ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u828471719/domains/donan22.com/public_html/resources/views/admin/sitemap/index.blade.php ENDPATH**/ ?>