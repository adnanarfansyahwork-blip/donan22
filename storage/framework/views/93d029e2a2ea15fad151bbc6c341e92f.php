...
<body class="bg-gray-100 min-h-screen flex items-center justify-center px-4">
    <div class="text-center">
        ...
        <div class="mt-6 space-x-4">
            <a href="<?php echo e(url('/')); ?>" class="inline-block px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium">
                Go Home
            </a>
...
<?php /**PATH /home/u828471719/domains/donan22.com/public_html/resources/views/errors/500.blade.php ENDPATH**/ ?>